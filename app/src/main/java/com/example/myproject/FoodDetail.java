...
public class FoodDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!foodId.isEmpty())
        {
            ...
            Log.d(TAG, "onCreate: " + foodId.toString());
        }
    ...
    private void getDetailFood(String foodId) {
        foods.child(foodId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                food_price.setText(currentFood.getPrice());
//                if (currentFood != null) Log.d(TAG, "onDataChange: empty");
//                Log.d(TAG, "onDataChange: ");
                ...
                numberButton.setOnValueChangeListener(new ElegantNumberButton.OnValueChangeListener() {
                    ...
                    public void onValueChange(ElegantNumberButton view, int oldValue, int newValue) {
                        Double price = Double.valueOf(currentFood.getPrice().toString());
                        int count = Integer.parseInt(numberButton.getNumber());
                        food_price.setText(Double.toString(price*count));
                    }
                });
